...
# Bayesian Inference: A Unified View of Estimation, Testing, and Intervals
...
These notes are based on the Bayesian components of Sections 12--17 of the MATH 5010 lecture notes: point estimation, evaluating estimators, hypothesis tests, evaluating tests, interval estimation, and evaluating interval estimators. Standard references include Casella and Berger, *Statistical Inference*; Larry Wasserman, *All of Statistics*; and the online probability and statistical inference resources used throughout the course.
